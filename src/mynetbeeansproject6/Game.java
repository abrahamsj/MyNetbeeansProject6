...
public class Game {
    ...
    public void start(){
        ...
        //TODO neely after you verify int, make a switch statement that assigns the enum and money based on game difficulty choice 
        //here is an example using if statement 
        if(gameDiffChoice == 1){
        ...
        /*
        example code:
        GameDifficultyEnum playerDifficulty = GameDifficultyEnum.EASY;
